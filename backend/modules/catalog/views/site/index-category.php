...
$this->registerJs('CatalogObj.type_layer = 0',  \yii\web\View::POS_HEAD);
$this->registerJs($jsx);
        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li><a id="add-new-catalog-category" href="<?=Yii::$app->homeUrl?>create-catalog-category"><i class="fa fa-plus"></i></a>
                    </li>
                </ul>
                <div class="clearfix"></div>
            </div>
                        ...
                        <?php
                            ...
                            foreach ($models as $model) {
                                ...
                                echo '<tr class="odd gradeX">
                                        <td>'.$start.'</td>
                                        <td id="category_name_'.$model['category_id'].'" >'.$model['category_name'].'</td>
                                        <td class="center">
                                            <a id="update-catalog-category-'.$model['category_id'].'" href="'.Yii::$app->homeUrl.'update-catalog-category/'.$model['category_id'].'" class="btn btn-xs btn-success update-obat" ><i class="fa fa-pencil"></i></a>
                                            <a id="status-catalog-category-'.$model['category_id'].'" href="javascript:void(0);" class="'.$_b_class.'" ><i id="icon-status-category-'.$model['category_id'].'" class="'.$_b_icon.'"></i></a>
                                        </td>
                                    </tr>';
                            }
                        ?>
