...
$this->params['breadcrumbs']['active'] = 'client';
...
$this->registerJs('ClientObj.type_layer = 1',  \yii\web\View::POS_HEAD);
$this->registerJs($jsx);
    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="<?=Yii::$app->homeUrl?>client"><i class="fa fa-chevron-left"></i></a></li>
